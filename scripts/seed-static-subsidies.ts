...
const STATIC_SUBSIDIES = [
  ...
  {
    external_id:  'static_jinzai_kaihatsu',
    title:        '人材開発支援助成金（厚生労働省）',
    catch_phrase: '従業員の研修・教育訓練・スキルアップ・資格取得の費用と訓練中の賃金を助成。理美容・飲食・小売も対象',
    description:  `事業主が雇用する従業員に対し、職務に関連した専門的な知識・技能を習得させるための職業訓練（OFF-JT・OJT）を計画的に実施した場合に、訓練経費や訓練期間中の賃金の一部を助成する助成金。従業員のスキルアップ・人材育成・教育訓練・研修・セミナー受講・資格取得支援・技術研修・リスキリングに幅広く活用できる。理美容業ではカット・カラー・パーマ等の技術研修、接客・カウンセリング研修、美容師・理容師のスキルアップ講習、飲食業では調理技術研修・衛生管理研修・接客研修、小売業では販売・接客研修・商品知識研修、宿泊業では接遇・語学研修などが対象になりうる。複数のコース（人材育成支援コース、教育訓練休暇等付与コース、人への投資促進コース、事業展開等リスキリング支援コース等）がある。外部研修機関への委託費・受講料・eラーニング・通信講座の費用も対象経費になる場合がある。訓練実施計画を事前に管轄労働局へ提出する必要がある。最新の要件・支給額は厚生労働省サイトで確認すること。`,
    target:       `飲食業、美容・理容業（美容室・理容室・ヘアサロン・エステ・ネイルサロン）、小売業、宿泊業などの中小企業・小規模事業者。従業員の研修・スキルアップ・教育訓練・資格取得・人材育成・リスキリングを支援したい事業者に最適。対象経費：外部研修受講料・講師謝金・教材費・eラーニング受講料・訓練期間中の賃金等。新人研修・技術研修・接客研修・マネジメント研修・資格取得支援などに活用可能。`,
    industry:     '共通_人材',
    prefecture:   null,
    max_amount:   null,
    subsidy_rate: '経費助成：中小企業は訓練経費の45〜75％（コース・賃金引上げ等の要件で変動）。賃金助成：1人1時間あたり760円〜（コースにより異なる）。詳細は厚労省・労働局で確認。',
    deadline:     null,
    accepted_at:  null,
    url:          'https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/koyou_roudou/jinzaikaihatsu/index.html',
  },
  {
    external_id:  'static_career_up',
    title:        'キャリアアップ助成金（厚生労働省）',
    catch_phrase: 'パート・アルバイトの正社員化や処遇改善を支援。スタッフの定着・採用力強化に',
    description:  `有期雇用労働者・パートタイム労働者・派遣労働者などの非正規雇用労働者の企業内でのキャリアアップ（正社員化・処遇改善）を促進するための助成金。代表的な「正社員化コース」では、有期雇用のパート・アルバイトを正社員に転換した場合に1人あたり一定額が助成される。そのほか賃金規定等改定コース・賞与退職金制度導入コース・社会保険適用時処遇改善コースなどがある。理美容業・飲食業・小売業・宿泊業など人手不足や人材定着に課題のある対面サービス業で、アルバイト・パートスタッフの正社員登用や待遇改善・処遇改善を進めたい場合に活用できる。従業員のモチベーション向上・離職防止・採用力強化にもつながる。キャリアアップ計画を事前に管轄労働局へ提出する必要がある。最新の要件・支給額は厚生労働省サイトで確認すること。`,
    target:       `飲食業、美容・理容業、小売業、宿泊業などでパート・アルバイト・契約社員を雇用する中小企業・小規模事業者。非正規スタッフの正社員化・正社員登用・処遇改善・賃金規定改定・待遇改善を行いたい事業者。従業員の定着・離職防止・モチベーション向上・働きやすい職場環境づくりに取り組みたい店舗に最適。`,
    industry:     '共通_人材',
    prefecture:   null,
    max_amount:   800000,
    subsidy_rate: '正社員化コース：有期→正規で1人あたり最大80万円（中小企業・要件により変動）。その他コースは内容により異なる。詳細は厚労省・労働局で確認。',
    deadline:     null,
    accepted_at:  null,
