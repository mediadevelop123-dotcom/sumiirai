...
- テンプレートに「Example_Input / Example_Output」が含まれる場合は、Example_Inputを元にした**カジュアル版とビジネス版の2パターン**のサンプル出力を最初に提示する。見出しは「**【カジュアル（LINE）】**」「**【ビジネス（メール）】**」のように付ける。その後「このように媒体・トーンに合わせて作成します。返信したいメッセージを貼り付けてください。」の2文で終わる
